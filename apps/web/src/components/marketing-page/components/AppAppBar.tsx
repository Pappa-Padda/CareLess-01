          ...
          <Box sx={{ display: { xs: 'flex', md: 'none' }, gap: 1 }}>
            ...
            >
              <Box sx={{ p: 2, backgroundColor: 'background.default' }}>
                ...
                <Divider sx={{ my: 3 }} />
                <MenuItem>
                  <Button color="primary" variant="contained" fullWidth component={Link} href="/sign-up">
                    Sign up
                  </Button>
                </MenuItem>
                <MenuItem>
                  <Button color="primary" variant="outlined" fullWidth component={Link} href="/sign-in">
                    Sign in
                  </Button>
                </MenuItem>
              </Box>
